  ...
  es: {
    ...
    auth: {
      ...
      passwordReset: {
        ...
        checkEmailDescription: 'Si el correo está registrado, recibirás un enlace para restablecer tu contraseña.',
        linkExpiry: 'El enlace expirará en 1 hora. Si no ves el correo, revisa tu carpeta de spam.',
        tryAnotherEmail: 'Intentar con otro correo',
        invalidLink: 'Enlace inválido',
        invalidLinkNoToken: 'No se proporcionó un token de restablecimiento.',
        invalidLinkExpired: 'El enlace ha expirado o ya fue utilizado.',
        requestNewLink: 'Solicitar nuevo enlace',
        newPassword: 'Nueva contraseña',
        newPasswordTitle: 'Nueva contraseña',
        newPasswordSubtitle: 'Ingresa tu nueva contraseña',
        confirmNewPassword: 'Confirmar contraseña',
        passwordHint: 'Mínimo 8 caracteres, una mayúscula, una minúscula y un carácter especial',
      ...
      sessionExpiredIdle: 'Tu sesión se cerró por inactividad',
      sessionExpiringWarning: 'Tu sesión expirará en 2 minutos. Mueve el ratón o pulsa una tecla para continuar.',
      ...
      errors: {
        ...
        tooManyAttempts: 'Demasiados intentos. Por favor, espera un minuto antes de volver a intentarlo.',
    ...
    trivia: {
      ...
      timerChoice: {
        title: '¿Jugar con cronómetro?',
        description: 'Responde antes de que se agote el tiempo para obtener puntos extra por velocidad.',
        withTimer: 'Con cronómetro',
        withoutTimer: 'Sin cronómetro',
      },
    ...
    forumList: {
      ...
      createForum: 'Crear Foro',
      search: 'Buscar',
      searchPlaceholder: 'Buscar foros...',
    ...
    blog: {
      ...
      subtitle: 'Historias y consejos de viajeros',
      featured: 'Destacados',
    ...
    notifications: {
      ...
      newComment: 'ha comentado en tu publicación',
      newLike: 'le gustó tu publicación',
      newFollow: 'te ha seguido',
      newMessage: 'te ha enviado un mensaje',
      newPost: 'ha publicado en un foro que sigues',
      justNow: 'Ahora mismo',
    ...
    feed: {
      ...
      postPlaceholder: 'Comparte tu experiencia de viaje...',
      publish: 'Publicar',
    ...
    comments: {
      ...
      confirmDelete: '¿Estás seguro de eliminar este comentario?',
  ...
  en: {
    ...
    auth: {
      ...
      passwordReset: {
        ...
        subtitle: 'We will send you instructions',
        ...
        checkEmailDescription: 'If the email is registered, you will receive a link to reset your password.',
        linkExpiry: 'The link will expire in 1 hour. If you don\'t see the email, check your spam folder.',
        tryAnotherEmail: 'Try another email',
        invalidLink: 'Invalid link',
        invalidLinkNoToken: 'No reset token was provided.',
        invalidLinkExpired: 'The link has expired or has already been used.',
        requestNewLink: 'Request new link',
        newPassword: 'New password',
        newPasswordTitle: 'New password',
        newPasswordSubtitle: 'Enter your new password',
        confirmNewPassword: 'Confirm password',
        passwordHint: 'Minimum 8 characters, one uppercase, one lowercase and one special character',
      ...
      sessionExpiredIdle: 'Your session was closed due to inactivity',
      sessionExpiringWarning: 'Your session will expire in 2 minutes. Move the mouse or press a key to continue.',
    ...
    trivia: {
      ...
      timerChoice: {
        title: 'Play with a timer?',
        description: 'Answer before time runs out to earn speed bonus points.',
    ...
    blog: {
      title: 'Travel Blog',
      subtitle: 'Stories and tips from travelers',
      featured: 'Featured',
    ...
    notifications: {
      ...
      newPost: 'posted in a forum you follow',
      justNow: 'Just now',
    ...
    feed: {
      ...
      postPlaceholder: 'Share your travel experience...',
      publish: 'Publish',
